...
console.log("Накопления за месяц " + appData.getAccumulatedMonth(money, appData.getExpensesMonth(amount2, amount1)));

let accumulatedMonth = appData.getAccumulatedMonth(money, appData.getExpensesMonth(amount2, amount1));
...
appData.getStatusIncome(budgetDay(accumulatedMonth));